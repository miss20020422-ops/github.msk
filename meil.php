...
$site_top = "https://miss20020422-ops.github.io/github.msk/#profile";

//管理者のメールアドレス（送信先） ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "miss20020422@gmail.com";
...
$Referer_check_domain = "miss20020422@gmail.com";
...
$require = array('お名前','メールアドレス','お問合せ内容');
